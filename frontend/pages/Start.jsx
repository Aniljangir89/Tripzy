    ...
    <div className='container'>
      ...
      <div className="page3">
        ...
        <div className="random_trip_img">
          <img src="\src\assets\10-1024x649.webp" alt="trip" />
        </div>
      </div>
      ...
      <div className="page4">
        <div className="socialmedia">
          <ul>
            ...
            <li><a href=""><img src="\src\assets\twitter.png" alt="" /></a></li>
            <li><a href=""><img src="\src\assets\instagram.png" alt="" /></a></li>
            <li><a href=""><img src="\src\assets\youtube.png" alt="" /></a></li>
            <li><a href=""><img src="\src\assets\linkedin.png" alt="" /></a></li>
          </ul>
        </div>
        <div className="location_english">
          <ul>
            <li><a href=""> <span><img alt="" src="\src\assets\earth.png" /></span>Location</a></li>
            <li><a href=""><span><img src="\src\assets\location.jpg" alt="" /></span>English</a></li>
          </ul>
        </div>
